	...
	public static void main(String[] args) {
		List<Employee> list = Arrays.asList(
				...
				new Employee("Joe", "Stevens", 200000), new Employee("Andrew",
						"Reardon", 89000), new Employee("Joe", "Cummings",
				...
				new Employee("Thomas", "Blake", 111000), new Employee("Alice",
						...
						100000));
		// print the number of Employees in list whose salary > 100000
		// and whose last name begins
		// with a letter that comes after the letter 'E'

		System.out.println("No of employee having first name after E: "
				+ LambdaLibrary.COUNT_LIST.apply(list, 'E', 100000));
		...
		System.out.println(LambdaLibrary.EMP_LIST.apply(list, 'R', 85000));
	}
}
