...
public class ProfileWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			RuleSet profileRuleSet = RuleSetFactory.getRuleSet(ProfileWindow.this);
			try {
				profileRuleSet.applyRules(ProfileWindow.this);
				...
				JOptionPane.showMessageDialog(ProfileWindow.this, "Error: " + e.getMessage(), "Input Error",
